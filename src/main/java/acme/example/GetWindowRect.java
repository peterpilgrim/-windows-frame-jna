...
public class GetWindowRect {
    ...
    public static void main(String[] args) {
        ...
        WindowUtils.getAllWindows(true).forEach(desktopWindow -> {
            System.out.printf("desktopWindow: [%d] %s\n", counter.getAndIncrement(), desktopWindow);
            System.out.printf("    desktopWindow.filePath=%s\n", desktopWindow.getFilePath());
            System.out.printf("    desktopWindow.HWND=%s\n", desktopWindow.getHWND());
            System.out.printf("    desktopWindow.title=%s\n", desktopWindow.getTitle());
            if (desktopWindow.getTitle().contains("IDEA")) {
                rect.setRect(desktopWindow.getLocAndSize());
                System.out.printf("        rect=%s\n", rect);
            }
        });
    }


    public static void main_SAVED(String[] args) {
